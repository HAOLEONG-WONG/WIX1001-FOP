...
public class FOP_Assignment_Test3_New {
   ...
   public static int CalculateMark (String Level, String Achievement){
      ...
      public static void main(String[] args) {
        ...
        //need to get value from previous part
        String matric_number="s100201";
        String society="society";
        String society_code="society_code";
        String uniform_body="uniform_body";
        String uniform_body_code="uniform_body_code";
        String sports_club="sports_club";
        String sports_club_code="sports_club_code";
